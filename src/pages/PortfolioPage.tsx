      ...
      <main id="home" className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        ...
        <section id="certificates" className="space-y-4">
          ...
          <GlassCard>
            ...
            <div className="mt-3">
              <a href={`${import.meta.env.BASE_URL}docs/certificates/computer-architecture.pdf`} target="_blank" rel="noreferrer" className="text-sm text-cyan-200 underline">View Certificate</a>
            </div>
          </GlassCard>
        </section>
